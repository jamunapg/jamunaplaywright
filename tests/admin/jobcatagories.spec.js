...
import loginfun from "./POM/login.po"
test("verify admin and add jobcatogaries",async({page})=>{   

await page.goto("https://opensource-demo.orangehrmlive.com/web/index.php/auth/login")
await page.locator(loginfun.username()).fill(data.username)
await page.locator(loginfun.password()).fill(data.password)
await page.locator(loginfun.submit).click()
